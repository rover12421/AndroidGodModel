...
import com.rover12421.android.godmodel.base.util.ClassLoaderHelper
import com.rover12421.android.godmodel.base.util.ProjectUtil
...
open class GodModelTransform(val project: Project) : Transform() {
    ...
    val godModelExtension: GodModelExtension = ProjectUtil.findOrCreateExtArgProject(project, GodModelExtension.ExtName, GodModelExtension::class.java)
    ...
    private fun transformFile(from: File, to: File, skip: Boolean) {
        addTask {
//            logger.log(LogLevel.WARN, "transformFile $from >> $skip >> size: ${godHand.godHands.size}")
    ...
    private fun transformDir(from: File, to: File, skip: Boolean) {
        addTask {
//            logger.log(LogLevel.WARN, "transformDir $from >> $skip")
            if (skip) {
                to.mkdirs()
